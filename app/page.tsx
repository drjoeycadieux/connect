  ...
  return (
    <div>
      <div>
        ...
        <br />
        <center>
          <button className="bg-gray-600 py-2 p-4 rounded text-white text-center hover:bg-gray-500">
            <svg
        ...
        <div className="flex justify-center items-center">
          <div className="bg-gray-200 hover:bg-gray-100 p-4 rounded-md shadow-md mx-2">
            <h1 className="text-2xl font-bold mb-4">Technologies</h1>
            <p className="text-gray-700">This is the content of card 1.</p>
          </div>
          <div className="bg-gray-200  hover:bg-gray-100  p-4 rounded-md shadow-md mx-2">
            <h1 className="text-2xl font-bold mb-4">Software do we use</h1>
            <p className="text-gray-700">This is the content of card 2.</p>
          </div>
          <div className="bg-gray-200  hover:bg-gray-100  p-4 rounded-md shadow-md mx-2">
            <h1 className="text-2xl font-bold mb-4">Cyber Safe</h1>
